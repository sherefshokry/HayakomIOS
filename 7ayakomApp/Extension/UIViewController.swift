...
extension UIViewController   {
    ...
    func showMessage(_ message: String) -> Void {
        ...
        alert.addAction(UIAlertAction(title: "OK".localize(), style: UIAlertAction.Style.cancel, handler: nil));
        present(alert, animated: true, completion: nil)
    }
    
    func showMessage(_ message: String,completion : @escaping (()->())) -> Void {
        let alert=UIAlertController(title: nil, message: message, preferredStyle: UIAlertController.Style.alert)
        alert.addAction(UIAlertAction(title: "OK".localize(), style: UIAlertAction.Style.cancel, handler: {(action) in
            completion()
        }));
    ...
    func areYouSureMsg(Msg : String , funcToLoad : @escaping ((Bool)->()) ){
        ...
        alert.addAction(UIAlertAction(title: "No".localize() , style: UIAlertAction.Style.cancel , handler: {(UIAlertAction) in
            funcToLoad(false)
        }))
        alert.addAction(UIAlertAction(title: "Yes".localize() , style: UIAlertAction.Style.default , handler: {(UIAlertAction) in
             funcToLoad(true)
